<script>
  ...
  <nav class="navbar navbar-dark bg-secondary navbar-expand-lg navbar-dark ">
    <div class="container">

      <a class="navbar-brand logo-font point" id="brand" on:click={goToHome}> OurShop </a>  
        ...
        <div class="collapse navbar-collapse" id="links">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active"><a class="nav-link point" on:click={goToCheckout}>Items in Cart
